...
@DisplayName("Login Tests for the-internet.herokuapp.com (CSV source & file)")
public class LoginTest {
    ...
    static void setUp() {
        ...
        prefs.put("profile.managed_default_content_settings.javascript", 2); // 1: Cho phép (default), 2: Chặn
                                                                             // JavaScript
